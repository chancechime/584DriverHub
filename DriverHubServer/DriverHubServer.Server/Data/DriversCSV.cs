namespace DriverHubServer.Data
{
    public class DriversCSV
    {
        ...
        public byte? Number { get; set; } = null!; // Driver Number
        public string Team { get; set; } = null!; // Team Name
        public string Country { get; set; } = null!; // Country of Origin
        public int? Podiums { get; set; } = null!; // Number of Podiums
        public float Points { get; set; } // Number of Points
