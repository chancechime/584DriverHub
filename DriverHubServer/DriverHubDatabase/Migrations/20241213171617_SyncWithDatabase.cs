    ...
    public partial class SyncWithDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RaceResultID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DriverID = table.Column<int>(type: "int", nullable: false),
                    Track = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    Position = table.Column<int>(type: "int", nullable: false),
                    Team = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    StartingGrid = table.Column<int>(type: "int", nullable: false),
                    Laps = table.Column<int>(type: "int", nullable: false),
                    TimeOrRetired = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
                    Points = table.Column<float>(type: "real", nullable: false),
                    SetFastestLap = table.Column<bool>(type: "bit", nullable: false),
                    FastestLapTime = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RaceResults", x => x.RaceResultID);
                    table.ForeignKey(
                        name: "FK_RaceResults_Drivers",
                        column: x => x.DriverID,
